      ...
      <div className={`absolute top-0 left-0 right-0 z-40 h-16 pointer-events-none ${isPlaying ? 'hidden' : ''}`}>
        ...
        <div className="relative z-10 flex items-center justify-between h-full px-4 max-w-7xl mx-auto pointer-events-auto">
          ...
          >
            ...
            <span className="text-primary font-bold hidden sm:inline shadow-black drop-shadow-md">Dracinkuu</span>
          </Link>
              ...
              <video
                ...
                onPlay={() => {
                  ...
                  addToHistory({
                    ...
                    platform: "freereels",
                    title: drama.title,
                    episode: currentEpisodeData ? (currentEpisodeData.index || 0) + 1 : undefined,
